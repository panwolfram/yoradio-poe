...
<title>LAN Streamer - Initial data upload</title><style>html, body { font-family: monospace; margin: 0; padding: 0; height: 100%; } body{background-color:#000;color:#4caf50;font-size:20px;display:flex;flex-direction:column;}
...
input[type=file]{color:#ccc;} input[type=file]::file-selector-button, input[type=submit]{border:2px solid #4caf50;color:#000;padding:6px 16px;border-radius:25px;background-color:#4caf50;margin:0 6px;cursor:pointer;}
...
input[type=text],input[type=password]{width:170px;background:#272727;color:#4caf50;padding:6px 12px;font-size:20px;border:#2d2d2d 1px solid;margin:4px 0 0 4px;border-radius:4px;outline:none;}
