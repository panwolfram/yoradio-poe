#line 1 "C:\\Users\\mwolfram\\Documents\\Arduino Projects\\yoradio\\yoRadio\\src\\core\\display.cpp"
#include "options.h"
...
void Display::_start() {
  ...
  if(_rssi)     _setRSSI(0);
  #ifndef HIDE_IP
    if(_volip) _volip->setText(ETH.localIP().toString().c_str(), iptxtFmt);
  #endif
...
void Display::_swichMode(displayMode_e newmode) {
  ...
  if (newmode == VOL) {
    ...
    #else
      _showDialog(ETH.localIP().toString().c_str());
    #endif
